...
DEFINE( "CT_LOCALIZATION_FILE", "locale/locale_en-us.inc.php" );
#DEFINE( "CT_LOCALIZATION_FILE", "locale/locale_hu.inc.php" );
...
# Add additional international characters here (used in security scrubbing on form/posted data)
DEFINE( "CT_INTERNATIONAL_CHARS", "ÁáÀÂàÂâÄäÃãÅåÆæÇçÐðÉéÈèÊêËëÍíÌìÎîÏïÑñÓóÒòÔôÖöÕõØøßÞþÚúÙùÛûÜüÝýÿ€¢£" );

# Sets the reply-to address on email notifications, def. is "codetrack@example.com"
DEFINE( "CT_RETURN_ADDRESS", "herb.gilliland@gmail.com" );
...
DEFINE( "CT_MAX_UPLOAD_FILE_SIZE", 2000000 );
...
# We recommend keeping this "" to force proactive severity ratings (Must add enhancements to localization file)
DEFINE( "CT_BUG_SEVERITIES",  "Fatal,Serious,Minor,Cosmetic,Change Req.");
DEFINE( "CT_DEFAULT_SEVERITY", "");

# Must add enhancements to localization file
...
# Categories of projects to track issues
DEFINE( "CT_PROJECT_TYPES", "Web-Based,Desktop Application,Data Analysis" );

# Label used in bug forms (i.e., "Developer Response")
DEFINE( "CT_PREFERRED_TITLES", "Developer,Analyst,Engineer" );


DEFINE( "CT_MAJOR_BROWSERS", ",IE 7,IE 6,IE 5.5,Firefox 2.x,Firefox 1.x,Safari,AOL," .
   "Opera 9,Opera 8,IE 5 Mac,(see note),N/A" );
...
DEFINE( "CT_MAJOR_OS", ",WinXP SP2,WinXP SP1,Win2K SP4,Win2K SP3,Win2K SP2,Win2K SP1," .
   ...
   "Linux,FreeBSD,OpenBSD,NetBSD,Solaris,Mac OSX");
...
DEFINE( "CT_ENABLE_AD_HOC_DEBUG", TRUE);     #  Default is FALSE
...
DEFINE( "CT_CODE_VERSION", "v. 0.99.4" );
...
DEFINE( "CT_SHOW_DELETED_BUGS", FALSE );

# Slashes ARE correct both for *nix AND Windows
# To customize, change CT_XML_DIRECTORY above, NOT those below.
