...
class HI_DB_oci8_driver extends HI_DB {
	...
	var $_commit = OHI_COMMIT_ON_SUCCESS;
	...
	function stored_procedure($package, $procedure, $params)
	{
		...
		foreach($params as $param)
		{
			...
			if (array_key_exists('type', $param) && ($param['type'] == OHI_B_CURSOR))
			{
				$have_cursor = TRUE;
			}
		}
	...
	function trans_commit()
	{
		...
		$this->_commit = OHI_COMMIT_ON_SUCCESS;
		return $ret;
	}
	...
	function escape_str($str, $like = FALSE)
	{
		...
		$str = $HI->input->_remove_invisible_characters($str);
