 ...
 * @category	XML-RPC
 * @author		ExpressionEngine Dev Team
 * @link		http://herbigniter.com/HI_user_guide/libraries/xmlrpc.html
 */
class HI_Xmlrpc {
	...
	var $xmlrpcName			= 'XML-RPC for HerbIgniter';
	...
	function HI_Xmlrpc ($config = array())
	{
 ...
 * @link		http://herbigniter.com/HI_user_guide/libraries/xmlrpc.html
 */
class XML_RPC_Client extends HI_Xmlrpc
{
	var $path			= '';
	var $server			= '';
	var $port			= 80;
	...
	function decode($array=FALSE)
	{
		...
		if ($array !== FALSE && is_array($array))
		{
			while (list($key) = each($array))
			{
				...
				{
					$array[$key] = $HI->input->xss_clean($array[$key]);
				}
			}
		...
		else
		{
			...
			{
				$result = $HI->input->xss_clean($result);
			}
		}
 ...
 * @link		http://herbigniter.com/HI_user_guide/libraries/xmlrpc.html
 */
class XML_RPC_Message extends HI_Xmlrpc
{
	var $payload;
	var $method_name;
	var $params			= array();
	...
	function output_parameters($array=FALSE)
	{
		...
		else
		{
			...
			for ($i = 0; $i < count($this->params); $i++)
			{
				...
				{
					$parameters[] = $HI->input->xss_clean($a_param);
				}
			}	
		}
 ...
 * @link		http://herbigniter.com/HI_user_guide/libraries/xmlrpc.html
 */
class XML_RPC_Values extends HI_Xmlrpc
{
	var $me 	= array();
	var $mytype	= 0;
