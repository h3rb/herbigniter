 ...
 * @category	Uploads
 * @author		ExpressionEngine Dev Team
 * @link		http://herbigniter.com/HI_user_guide/libraries/file_uploading.html
 */
class HI_Upload {
	 ...
	 * @access	public
	 */
	function HI_Upload($props = array())
	{
		if (count($props) > 0)
		{
	...
	function set_error($msg)
	{
		...
		if (is_array($msg))
		{
			foreach ($msg as $val)
			{
				$msg = ($HI->lang->line($val) == FALSE) ? $val : $HI->lang->line($val);				
				$this->error_msg[] = $msg;
		...
		{
			$msg = ($HI->lang->line($msg) == FALSE) ? $msg : $HI->lang->line($msg);
			$this->error_msg[] = $msg;
			log_message('error', $msg);
		}
	}
