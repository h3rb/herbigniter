 ...
 * @category	Libraries
 * @author		ExpressionEngine Dev Team
 * @link		http://herbigniter.com/HI_user_guide/libraries/email.html
 */
class HI_Email {

	var	$useragent		= "HerbIgniter";
	 ...
	 */
	function HI_Email($config = array())
	{
		if (count($config) > 0)
		{
	...
	function _set_error_message($msg, $val = '')
	{
		...
		if (FALSE === ($line = $HI->lang->line($msg)))
		{
