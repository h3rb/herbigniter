...
var days		= new Array(
					'<?php echo $HI->lang->line('cal_su');?>', // Sunday, short name
					'<?php echo $HI->lang->line('cal_mo');?>', // Monday, short name
					'<?php echo $HI->lang->line('cal_tu');?>', // Tuesday, short name
					'<?php echo $HI->lang->line('cal_wed');?>', // Wednesday, short name
					'<?php echo $HI->lang->line('cal_thu');?>', // Thursday, short name
					'<?php echo $HI->lang->line('cal_fri');?>', // Friday, short name
					'<?php echo $HI->lang->line('cal_sat');?>' // Saturday, short name
				);
var months		= new Array(
					'<?php echo $HI->lang->line('cal_january');?>',
					'<?php echo $HI->lang->line('cal_february');?>',
					'<?php echo $HI->lang->line('cal_march');?>',
					'<?php echo $HI->lang->line('cal_april');?>',
					'<?php echo $HI->lang->line('cal_mayl');?>',
					'<?php echo $HI->lang->line('cal_june');?>',
					'<?php echo $HI->lang->line('cal_july');?>',
					'<?php echo $HI->lang->line('cal_august');?>',
					'<?php echo $HI->lang->line('cal_september');?>',
					'<?php echo $HI->lang->line('cal_october');?>',
					'<?php echo $HI->lang->line('cal_november');?>',
					'<?php echo $HI->lang->line('cal_december');?>'
				);
