...
/**
 * HerbIgniter PROJAX - INCLUDE ONLY ONCE.
 *
 * @package		HerbIgniter
 * @subpackage		Helpers
 * @category		Javascript, JQuery, Prototype, Scriptaculous, AJAX
 * @author		Herb
 * @link		http://gudagi.net/herbigniter/HI_user_guide/helpers/projax_helper.html
 */
...
For the first tutorial lets start with a very common and widely used auto-completing effect.This tutorial is also availible in your demos directory.
   ...
   1. First thing you need to do is install Projax and include the file in your script.
   2. Now lets create a new instance of Projax though which all the functionality will be accessed. $projax = new Projax();
   3. Once you have intialized the class lets show the input box which requires auto-completion. Please enter your year of birth :
      <?=$projax->text_field_with_auto_complete('dob',null,array('url'=>'index.php?task=ajax'));?>
   4. When you enter anything into this it will call the url index.php?task=ajax , Itll pass the current value of dob as $_POST['dob'].The called page should return a list of matching values. for($i=1900;$i<2006;$i++)$ret_val.=(strstr($i,$_POST['dob']))?'<li>'.$i.'</li>':'';
      echo '<ul>'.$ret_val.'</ul>';
...
class Prototype extends JavaScript  {
	...
	/////////////////////////////////////////////////////////////////////////////////////
	//                            Merged Javascript Generator helpers
	/////////////////////////////////////////////////////////////////////////////////////
...
/* End of file projax_helper.php */
/* Location: ./system/helpers/projax_helper.php */